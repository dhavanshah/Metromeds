DROP SCHEMA IF EXISTS metromeds;

CREATE SCHEMA metromeds;
...
(
    ...
    customer_tier VARCHAR(50) NOT NULL DEFAULT 'silver',
...
(
    ...
    cart_price       DECIMAL(18, 2) NOT NULL DEFAULT '0.00',
    delivery_charge  DECIMAL(18, 2) NOT NULL DEFAULT '0.00',
    amount_payable   DECIMAL(18, 2) NOT NULL DEFAULT '0.00',
    service_type     VARCHAR(25),
    order_type       VARCHAR(25),
    is_prescribed    NUMBER(1),
...
(
    id INT NOT NULL,
    order_id INT,
    total_amount DECIMAL(19, 4) NULL DEFAULT '0.0000',
    customer_id INT,
...
ALTER TABLE order_items
    ADD CONSTRAINT fk_order_items__orders FOREIGN KEY (order_id) REFERENCES orders (id);
ALTER TABLE order_items
    ADD CONSTRAINT fk_order_items__products FOREIGN KEY (product_id) REFERENCES products (id);



CREATE
OR REPLACE VIEW order_info AS
...
CREATE
OR REPLACE VIEW employee_orders AS
select o.order_date
     , o.order_status
     , o.paid_date
     , o.payment_type
